...
export const tourSteps: TourStep[] = [
  ...
  },
  {
    ...
    y: 800,
    img: '/sprites/LucasSpinningBall7.png',
    text: 'Training facility tunnel — track cardio in the Gym, log strength in the Weight Room, and run benchmarks in the Combine.',
    mobileText: 'Training facility — Gym, Weight Room, Combine.',
    glow: { x: 1115, y: 680, width: 180, height: 160 },
    facingLeft: false,
    targetId: 'enter-training-facility',
    paddingFactor: 0.99,
  },
  {
    x: 200,
