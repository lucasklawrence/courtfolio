...
export function ZoneBarsSafari() {
  return (
    ...
    >
      <h3 style={{ fontSize: '1.125rem', fontWeight: 'bold', color: '#FDBA74', textAlign: 'center' }}>
        🎤 Bars of the Day
      </h3>
      <p style={{ fontSize: '0.75rem', textAlign: 'center', marginTop: '0.5rem', lineHeight: '1.2rem', color: '#fff' }}>
        A daily drop of lyrical greatness — curated hip-hop bars with clean typography and smooth flow.
      </p>
      <p style={{ fontSize: '0.75rem', fontStyle: 'italic', color: '#fb923c', textAlign: 'center', marginTop: '0.25rem' }}>
