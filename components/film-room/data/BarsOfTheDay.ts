...
export const BARS_OF_THE_DAY: Project = {
  ...
  tagline: 'Syncing rap genius with React animations.',
  description:
    'An experimental playground syncing lyric timing with visual animations — bridging frontend flair with music intelligence.',
  coverImage: '/projects/bars-cover.png',
  slides: [
    {
      type: 'text',
