...
/**
 * NotFound renders the custom court-themed 404 page (issue #40).
 *
 * Variant A — "AIRBALL": a basketball arcs from the low-left of the stage,
 * peaks high above a hoop on the right, and sails wide off-screen — the
 * literal airball that gives the page its punchline. The missed route is
 * surfaced inline so visitors immediately see what they were trying to load.
 */
export default function NotFound() {
  ...
  return (
    ...
    >
      ...
      {/* hoop on the right — ball will sail wide past it */}
      <svg
        className="absolute z-[2]"
        style={{ right: '32%', top: '22%', width: '110px', height: '130px' }}
        viewBox="0 0 110 130"
        fill="none"
