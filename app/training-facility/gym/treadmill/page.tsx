 ...
 * the treadmill click target on the Gym scene; gated behind the Gym feature
 ...
 * `null` from the cardio reader means "every cardio table is empty", a normal
 * state the view handles.
 *
 ...
 */
export default async function TrainingFacilityGymTreadmillPage(): Promise<JSX.Element> {
