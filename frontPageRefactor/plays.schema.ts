/**
 * Play System Schema (TypeScript)
 * Use this as a contract for data-driven play definitions.
 */
...
export type Play = {
  ...
  principleId: string; // e.g. "scalability"
  shotId: string;      // e.g. "drive"
...
export type PlayKey = `${string}::${string}`; // principleId::shotId
